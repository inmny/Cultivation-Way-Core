...
namespace Cultivation_Way.Library
{
    ...
    public class CW_Library_Building : CW_Asset_Library<CW_Asset_Building>
    {
        ...
        {
            CW_Asset_Building building = new CW_Asset_Building() { id = origin_asset.id, cw_base_stats = addition_stats == null ? new CW_BaseStats() : addition_stats, destroy_action = destroy_action, origin_stats = origin_asset };
