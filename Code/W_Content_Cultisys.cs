...
namespace Cultivation_Way.Content
{
    internal class W_Content_Cultisys
    {
        ...
        {
            return cw_actor.cw_cur_stats.base_stats.health * cw_actor.cw_cur_stats.base_stats.damage * cw_actor.cw_cur_stats.base_stats.armor / ((cw_actor.cw_stats.cw_base_stats.base_stats.health+1) * (cw_actor.cw_stats.cw_base_stats.base_stats.damage+1) * (cw_actor.cw_stats.cw_base_stats.base_stats.armor+1)) >= 1.15f;
        }
