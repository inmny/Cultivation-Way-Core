...
{
    public class CW_Library_ItemAccessoryMaterial : ItemAssetLibrary<CW_Asset_Item>
    {
        ...
        {
            if (!AssetManager.items_material_accessory.list.Contains(pAsset)) AssetManager.items_material_accessory.add(pAsset);
            return base.add(new CW_Asset_Item(pAsset));
        }
        public CW_Asset_Item add(ItemAsset asset, CW_BaseStats addition_stats)
        {
            if (!AssetManager.items_material_accessory.list.Contains(asset)) AssetManager.items_material_accessory.add(asset);
