...
namespace Cultivation_Way.HarmonySpace
{
    internal static class H_City
    {
        ...
        public static bool produceNewCitizen_prefix(CityBehProduceUnit __instance, Building pBuilding, City pCity, ref bool __result)
        {
            __result = false;
            Actor parent_1 = __instance._possibleParents.Pop<Actor>();
            if (parent_1 == null)
            {
                return false;
            }
            ...
            {
                parent_2 = __instance._possibleParents.Pop<Actor>();
            }
        ...
        private static ActorAsset inherit_from_parents(ActorData child_data, Actor parent_1_actor, Actor parent_2_actor)
        {
            ...
            {
                child_data.set_element(CW_Element.get_element_for_set_data(cw_asset.prefer_element, cw_asset.prefer_element_scale));
            }
            else
            {
