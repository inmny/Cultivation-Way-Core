...
namespace Cultivation_Way.Content
{
    internal static class W_Content_KingdomAndRace
    {
        ...
        private static void add_yao_race()
        {
            CW_Asset_Race race = new CW_Asset_Race();
            race.id = "yao";
            race.origin_asset = new Race();
            Race origin = race.origin_asset;
            origin.banner_id = "orc";
            origin.buildingPlacements = BuildingPlacements.Center;      // 随机放置建筑
            origin.build_order_id = "yao";                              // 建筑顺序
            origin.civilization = true;                                 // 城镇化，能够随机产生特质、按性别产生名字、作为第一个居民能够设置国家的种族
            origin.civ_baseArmy = 10;                                   // 城市的基础军队规模
            origin.civ_baseCities = 3;                                  // 国家可容纳的基础最大城市数量
            origin.civ_base_zone_range = 5;                             // 城市的基础区域范围
            ...
            origin.culture_rate_tech_limit = 3;                         // 文化稀有科技数量限制, "rare"
            origin.hateRaces = "eastern_human";                         // 敌对种族
            origin.nameLocale = "Yaos";                                 // 统计数据中使用的id
            ...
            origin.nomad_kingdom_id = "nomads_yao";                     // 种族的默认隐藏国家
            origin.path_icon = "ui/Icons/iconYaos";                     // 种族图标
            ...
            origin.roads_forbideen = true;                              // 允许建路
            ...
            origin.stats.culture_spread_speed.value = 3;                // 文化传播速度
            origin.stats.culture_spread_convert_chance.value = 0.1f;    // 文化转化速度
        ...
        private static void add_yao_kingdom()
        {
            ...
            origin.addTag("civ");
            origin.addTag("yao");
            origin.addTag("nature_creature");
            origin.addFriendlyTag("yao");
            origin.addFriendlyTag("neutral");
            origin.addFriendlyTag("nature_creature");
            origin.addFriendlyTag("good");
            origin.addEnemyTag("eastern_human");
