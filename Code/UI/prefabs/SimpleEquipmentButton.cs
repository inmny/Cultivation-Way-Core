...
public class SimpleEquipmentButton : APrefab<SimpleEquipmentButton>
{
    ...
    public void Setup(ItemData pItemData, Vector2 pSize = default)
    {
        ...
        outline.show(
            Colors.GetContainerItemColor(Toolbox.colorToHex(ItemIconConstructor.GetItemQualityColor(pItemData))));
    }
    ...
    public override void SetSize(Vector2 pSize)
    {
        ...
        outline.GetComponent<RectTransform>().sizeDelta = new Vector2(pSize.x * 0.8f, pSize.x * 0.8f);
        text.GetComponent<RectTransform>().sizeDelta = new Vector2(pSize.x * 0.9f, pSize.y * 0.15f);
        outline.transform.localPosition = new Vector2(0, pSize.y * 0.12f);
    }
    ...
    private static void _init()
    {
        ...
        GameObject outline = new("Outline", typeof(Image), typeof(IconOutline), typeof(LayoutElement));
