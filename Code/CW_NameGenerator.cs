...
namespace Cultivation_Way
{
    public class CW_NameGenerator
    {
        ...
        public static string gen_name(string template_id, CW_Actor cw_actor = null, City city = null, Kingdom kingdom = null, Culture culture = null, WorldTile tile = null)
        {
            string result = __gen_name(template_id, cw_actor, city, kingdom, culture, tile);
            if(!string.IsNullOrEmpty(result)) return result;
            return NameGenerator.generateNameFromTemplate(AssetManager.nameGenerator.get(template_id), cw_actor);
        }
        internal static string __gen_name(string template_id, CW_Actor cw_actor=null, City city = null, Kingdom kingdom=null, Culture culture=null, WorldTile tile = null)
        {
            ...
            {
                return name_generator.gen_name(null, cw_actor, city, kingdom, culture, tile);
            }
            return "";
        }
    }
