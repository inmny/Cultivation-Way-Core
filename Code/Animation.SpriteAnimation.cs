...
namespace Cultivation_Way.Animation
{
    ...
    public class SpriteAnimation
    {
        ...
        internal SpriteAnimation(AnimationSetting setting, Sprite[] sprites, GameObject prefab, Vector2 src_vec, Vector2 dst_vec, BaseSimObject src_object, BaseSimObject dst_object)
        {
            ...
            gameObject = UnityEngine.Object.Instantiate(prefab, EffectManager.instance.transform);
            gameObject.layer = 0;
        ...
        internal void set(AnimationSetting setting, Sprite[] sprites, GameObject prefab, Vector2 src_vec, Vector2 dst_vec, BaseSimObject src_object, BaseSimObject dst_object)
        {
            isOn = true; is_default_sprites = true;
            this.setting = setting;
            ...
            else
            {
                ...
                */
                if (cur_frame_idx != setting.anim_froze_frame_idx)
                {
                    ...
                    if (setting.visible_in_low_res || !EffectManager.instance.low_res) renderer.sprite = sprites[next_frame_idx];
            ...
            */
            ...
            switch (setting.loop_limit_type)
            {
                ...
                case AnimationLoopLimitType.DST_LIMIT:
                    {
                        if (Toolbox.Dist(dst_vec.x, dst_vec.y, gameObject.transform.position.x, gameObject.transform.position.y) < Constants.Others.anim_dst_error || trace_length >= Constants.Others.max_anim_trace_length) end = true;
                        break;
                    }
        ...
        {
            if (deepcopy) { this.setting = setting.__deepcopy(); this.setting.possible_referenced = false; }
        ...
        {
            if (safety || !this.setting.possible_referenced) return this.setting.__deepcopy();
            return this.setting;
        }
        /// <summary>
        /// 获取运行状态
