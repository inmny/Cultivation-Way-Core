...
public class EffectController
{
        ...
        GameObject default_prefab, float base_scale, Vector2 base_offset)
    {
        ...
        prefab = Object.Instantiate(default_prefab, CW_Core.instance.transform);
        ...
        renderer.transform.localPosition = new Vector3(base_offset.x + renderer.transform.localPosition.x,
            base_offset.y + renderer.transform.localPosition.y, renderer.transform.localPosition.z);

        active_anims = new CW_ForwardLinkedList<SpriteAnimation>();
        inactive_anims = new Stack<SpriteAnimation>((int)Mathf.Sqrt(anim_limit));
        ...
        float scale)
    {
        ...
        else if (active_anims.Count <= anim_limit)
        {
