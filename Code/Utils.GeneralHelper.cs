...
namespace Cultivation_Way.Utils
{
    public static class GeneralHelper
    {
        ...
        public static bool is_enemy(BaseSimObject obj_1, BaseSimObject obj_2)
        {
            ...
            return ((!obj_1.kingdom.asset.mobs && !obj_2.kingdom.asset.mobs) || !MapBox.instance.worldLaws.world_law_peaceful_monsters.boolVal) && obj_2.kingdom.isEnemy(obj_1.kingdom);
        }
    }
}
